function doGet(e) { 
    ...
    if (e.parameter == 'undefined') {
      ...
      var sheet_id = '1NSdpLm4lA225_NH-1-uumw_hYY9u-CDbiSxekI39r3c'; 	// Spreadsheet ID.
      ...
      Data_for_H3 = Curr_Date;  // Date will be written in column I3 (in the "Latest DHT11 Sensor Data" section).
      ...
      Data_for_I3 = Curr_Time;  // Time will be written in column J3 (in the "Latest DHT11 Sensor Data" section).
      ...
      for (var param in e.parameter) {
        ...
        switch (param) {
          ...
          case 'srs':
            ...
            Data_for_J3 = value;  // Sensor Reading Status will be written in column J3 (in the "Latest DHT11 Sensor Data" section).
          ...
          case 'temp':
            ...
            Data_for_K3 = value;  // The temperature value will be written in column K3 (in the "Latest DHT11 Sensor Data" section).
          ...
          case 'humd':
            ...
            Data_for_L3 = value;  // The humidity value will be written in column L3 (in the "Latest DHT11 Sensor Data" section).
          ...
          case 'CO2':
            ...
            Data_for_M3 = value;  // The state of Switch_1 will be written in column M3 (in the "Latest DHT11 Sensor Data" section).
            result += ', CO2 PPM Written on column F';
            break; 
          ...
          case 'CO':
            ...
            result += ', CO PPM Written on column F';
            break; 
      ...
      if (sts_val == 'write') {
        ...
        var RangeDataLatest = sheet_target.getRange('H4:N4');
        RangeDataLatest.setValues([[Data_for_H3, Data_for_I3, Data_for_J3, Data_for_K3, Data_for_L3, Data_for_M3, Data_for_N3]]);
      ...
      if (sts_val == 'read') {
        ...
        var all_Data = sheet_target.getRange('J4:N4').getValues();
